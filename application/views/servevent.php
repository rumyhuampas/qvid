    ...
    <div class="container floated">
		...
		<div class="eleven floated">
			<div class="page-content">
				...
				<h3 class="margin-reset">Eventos deportivos</h3><br />
				<p><img class="image-right" src=<?php echo URL::base()."assets/images/resources/services/event.jpg" ?> style="width: 45%;" alt="" />
