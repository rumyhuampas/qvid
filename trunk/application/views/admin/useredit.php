						...
						echo Form::open('admin/users/edit', array('method' => 'POST'));
							...
							echo '<fieldset>';
								...
								echo '<div>';
									...
									echo Form::input('useroldpass', 'Contraseña Actual', array('onblur' => "if(this.value=='')this.value='Contrasena Actual';", 'onfocus' => "if(this.value=='Contrasena Actual')this.value='';"));
								echo '</div>';
								echo '<div>';
